# A program that deciphers 'encrypted_message.py' messages using the same key cipher. This program
...
def main():
    ...
    text = get_string("Enter Encrypted Message: ")
    k_index = 0
    lenk = len(k)

    # output with the encrypted key
    print("Original Message Below: ")
    for char in text:
        if char.islower():
